export const input = `L.LLLLLLLLLL.LLLLLLLLL.LLLLLLLLL.LLL.LL.LLLLLLLLL.LLLLLL.LLLL.LL..LLLL.LLLL.LLL.LL.LLLLLLL
...
export const makeSimpleMatrix = (str, mapper = (x) => x) =>
  str.split('\n').map((line) => line.split('').map(mapper));

export const grid = makeSimpleMatrix(input);
